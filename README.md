...
- Poster (s. Abschnitt "Kurzbeschreibung des Werks")
- Analyseergebnisse in Tabellenform (s. Abschnitt "Hintergrund des Werks")

## Kurzbeschreibung des Werks
Dieses Repository ist der Ablageort der finalen Poster, die im Rahmen des Praxisprojekts mit dem obigen Namen entstanden. Das Projekt wurde an der Technischen Hochschule Köln unter der Betreuung von Christian Noss durchgeführt.
